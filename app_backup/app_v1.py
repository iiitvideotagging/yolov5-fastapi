...
# st.beta_set_page_config(page_title='IIIT Object Detector',page_icon=':detect:')
...
def videoInput(device, src):
    ...
    if uploaded_video != None:
        ...
        detect(weights=cfg_model_path, source=imgpath, device=0) if device == 'cuda' else detect(weights=cfg_model_path,
                                                                                                 source=imgpath,
                                                                                                 device='cpu')
...
def main():
    ...
    st.sidebar.markdown("We are team 5!!!")
    # -- End of Sidebar

    st.header('📦 IIIT Hyderabad - Object Detection')
